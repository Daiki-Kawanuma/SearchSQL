...
using Xamarin.Forms;
using List = CoreTweet.List;

namespace TwitterSQL.ViewModels
{
    public class ListResultPageViewModel : BindableBase, INavigationAware
    {
        ...
        public List<List> ListSource { get; set; }
        ...
        public ListResultPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService)
        {
        ...
        public void OpenListUrl(string url)
        {
            var uri = new Uri(url);
            Device.OpenUri(uri);
        }
        ...
        public async void OnNavigatedTo(NavigationParameters parameters)
        {
            ...
            try
            {
                ...
                Debug.WriteLine("Lisy.Count: " + list.Count);
                ...
                if (list.GetType() == typeof(List<List>))
                {
